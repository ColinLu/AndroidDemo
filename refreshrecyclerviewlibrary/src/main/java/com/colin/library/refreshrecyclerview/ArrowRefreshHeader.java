package com.colin.library.refreshrecyclerview;
...
import com.colin.library.refreshrecyclerview.progressindicator.RefreshLoadingIndicatorView;
...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView(Context context) {
        ...
        RefreshLoadingIndicatorView progressView = new RefreshLoadingIndicatorView(context);
    ...
    public void setProgressStyle(int style) {
        if (style == ProgressStyle.SysProgress) {
            ...
            RefreshLoadingIndicatorView progressView = new RefreshLoadingIndicatorView(this.getContext());
            progressView.setIndicatorColor(0xffB5B5B5);
