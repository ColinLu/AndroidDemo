package com.colin.demo.custom.view;
...
import com.colin.library.help.WindowsHelp;
...
public class ShaderView extends View {
    ...
    public ShaderView(Context context, AttributeSet attrs) {
        ...
        // 获取屏幕尺寸数据
        int[] screenSize = WindowsHelp.getDisplayMetrics((Activity) context);
...
//        LogHelp.d(Arrays.toString(values));

        // 设置着色器

//        注意BitmapShader是先应用了Y轴的模式而X轴是后应用的！所以着色是先在Y轴拉伸了然后再沿着X轴重复？！
...
//        SweepGradient梯度渐变，也称之为扫描式渐变，因为其效果有点类似雷达的扫描效果
